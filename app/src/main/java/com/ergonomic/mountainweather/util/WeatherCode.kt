...
fun weatherCodeToInfo(code: Int, isDay: Boolean = true): WeatherInfo = when (code) {
    ...
    2 -> WeatherInfo(R.string.wc_partly_cloudy, if (isDay) "⛅" else "☁️🌙")
    3 -> WeatherInfo(R.string.wc_overcast, "☁️")
    45, 48 -> WeatherInfo(R.string.wc_fog, "🌫️")
    51 -> WeatherInfo(R.string.wc_light_drizzle, if (isDay) "🌦️" else "🌧️🌙")
    53 -> WeatherInfo(R.string.wc_moderate_drizzle, if (isDay) "🌦️" else "🌧️🌙")
    55 -> WeatherInfo(R.string.wc_dense_drizzle, "🌧️")
    56, 57 -> WeatherInfo(R.string.wc_freezing_drizzle, "🌧️")
    61 -> WeatherInfo(R.string.wc_light_rain, if (isDay) "🌦️" else "🌧️🌙")
    ...
    80 -> WeatherInfo(R.string.wc_light_showers, if (isDay) "🌦️" else "🌧️🌙")
